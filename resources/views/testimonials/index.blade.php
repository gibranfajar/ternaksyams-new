...
@section('content')
    <div class="pc-container">
        <div class="pc-content">
            ...
            @include('testimonials.modalcreate')
                    ...
                    <div class="tab-pane fade {{ $key === 0 ? 'show active' : '' }}" id="variant-{{ $type['id'] }}"
                        ...
                        <div class="table-responsive">
                            <table id="myTable-{{ $type['id'] }}" class="table table-bordered table-striped align-middle">
                                ...
                                <tbody>
                                    @foreach ($testimonials->where('target', $type['target']) as $testimonial)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group gap-2" role="group">
                                                    <form
                                                        action="{{ route('testimonials.toggleStatus', $testimonial->id) }}"
                                        ...
                                        @include('testimonials.modaledit', ['testimonial' => $testimonial])
                                    @endforeach
                                </tbody>
                            </table>
                        </div>
