    ...
    <div class="pc-container">
        <div class="pc-content">
            ...
            <div class="page-header mb-4">
                <h3>Create Hardselling Footer</h3>
            </div>

            <div class="row">
                <div class="col-sm-12">
                    <form action="{{ route('hardselling-footers.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="tiktok"
                                                placeholder="Enter Tiktok URL" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        {{-- INSTAGRAM --}}
